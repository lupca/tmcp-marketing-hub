...
const SocialPostCard: React.FC<SocialPostCardProps> = React.memo(({ mc, mcVariants, isExpanded, onToggleExpand, campaignsById, form, onPushVariant, isPublishingVariantId }) => {
